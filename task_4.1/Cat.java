...
public class Cat {
    ...
    public boolean fight(Cat anotherCat) {
        ...
        int win=0;
        if (this.age> anotherCat.age) win++; else (this.age<anotherCat.age) win--;    
        if (this.weight> anotherCat.weight) win++; else (this.age<anotherCat.weight) win--;
        if (this.strenght> anotherCat.strenght) win++; else (this.strenght<anotherCat.strenght) win--;    
